module github.com/bartkeeper/quasar-challenge-grpc/m

go 1.18

require (
	github.com/cosmos/cosmos-sdk v0.46.0-beta2.0.20221202155722-ca0b1deeea10
...
require (
	...
	github.com/nexidian/gocliselect v1.0.0 // direct
